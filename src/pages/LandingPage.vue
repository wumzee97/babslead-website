...
<template>
  <div>
    <div class="hero-b bg-hero-gradient bg-no-repeat -mt-[190px] pt-32 lg:pt-32 relative overflow-hidden" ref="heroRef">
      <!-- Animated gradient background -->
      <div class="absolute inset-0 bg-gradient-to-br from-schemes-primary-default via-dark to-schemes-primary-container animate-gradient"></div>
    ...
    <TestimonialSection />
    <div class="hero-b bg-hero-gradient bg-no-repeat -mt-[190px] pt-32 lg:pt-32">
      <ContactUsSection />
    </div>
  </div>
</template>
